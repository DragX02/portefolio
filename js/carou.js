...
class Carousel3D {
    constructor(id, imgs) {
        ...
        // initialisation seulement si le conteneur existe
        if (this.container) {
            this.init();
        }
    }
    ...
    init() {
        ...
        // calcul de l'angle pour répartir les images uniformément en cercle
    ...
    // rotation du carousel dans la direction donnée (1 = droite, -1 = gauche)
    rotate(dir) {
